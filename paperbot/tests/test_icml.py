...
def test_icml_fetch():
    crawler = PMLRCrawler(year=2025, conference="ICML")
    ...
    for i, p in enumerate(papers):
        ...
        assert p.conference == "ICML", f"Paper {i} conference mismatch: {p.conference}"
    ...
    print(f"ICML 2025: {len(papers)} papers fetched successfully")
